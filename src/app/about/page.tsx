  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.heroSection}>
        <PremiumImage src="/images/hero/texture.jpg" alt="About" fill overlay="maroon" containerClassName={styles.heroOverlay} />
          ...
          <ScrollReveal direction="right">
            <div style={{ position: 'relative' }}>
              ...
              <div className={styles.imageWrapper}>
                <PremiumImage src="/images/guru/portrait.jpg" alt={academyConfig.guru.name} fill />
              </div>
            </div>
          </ScrollReveal>
